...
type Actor interface {
	...
	DeleteBuildpackByNameAndStack(buildpackName string, buildpackStack string, lifecycle constant.AppLifecycleType) (v7action.Warnings, error)
	...
	GetBuildpackLabels(buildpackName string, buildpackStack string, lifecycle constant.AppLifecycleType) (map[string]types.NullString, v7action.Warnings, error)
	GetBuildpacks(labelSelector string, lifecycle constant.AppLifecycleType) ([]resources.Buildpack, v7action.Warnings, error)
